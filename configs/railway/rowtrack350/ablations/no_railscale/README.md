...
当前包含 `scene_05_train`、`scene_11_train`、`scene_13_train`、`scene_14_train`、`scene_16_train`、`scene_17_train`、`scene_19_train`。
...
/home/leizongru/miniconda3/envs/gigaslam/bin/python slam.py \
