...
```bash
cd /root/GigaSLAM
/root/miniconda3/envs/gigaslam/bin/python slam.py --config configs/railway/rowtrack350/scenes/scene_16_train.yaml
```
...
```bash
cd /root/GigaSLAM
/root/miniconda3/envs/gigaslam/bin/python slam.py --config configs/railway/rowtrack350/full_mainline/scenes/scene_16_train.yaml
```
...
```bash
cd /root/GigaSLAM
/root/miniconda3/envs/gigaslam/bin/python slam.py --config configs/railway/rowtrack350/ablations/no_railscale/scene_16_train.yaml
```
