...
class FrontEnd(mp.Process):
    ...
    def add_new_keyframe(self, cur_frame_idx, init=False):
        ...
        initial_depth = torch.tensor(viewpoint.depth).cuda().unsqueeze(0)
    ...
    def run(self):
        ...
        while True:
            ...
            if self.frontend_queue.empty():
                ...
                del image_ori_for_depthmodel, predictions, depth_pred
                ...
                if not self.initialized:
                    is_backend_keyframe = True
                else:
                    is_backend_keyframe = self.is_keyframe(cur_frame_idx, last_keyframe_idx)
